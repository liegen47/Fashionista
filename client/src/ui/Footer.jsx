  ...
  return (
    <footer className="grid grid-cols-1 md:(grid-cols-3) border-t border-gray-300 bg-gray-200 px-4">
      <div className="m-4 sm:m-6 flex-1">
        <h2 className="text-4xl text-center md:text-left mb-4">Fashionista</h2>
        <p className="text-justify text-gray-700">
          Eiusmod duis reprehenderit quis cillum nisi anim consectetur occaecat
          cupidatat anim incididunt aliqua eiusmod ad consectetur in ut
          cupidatat proident dolore aute irure enim in in ut adipisicing in do
          est.
        </p>
      ...
      <div className="m-4 sm:m-6">
        ...
        <ul className="space-y-3 text-gray-700">
          ...
          <li className="flex items-center">
            ...
            <a href="mailto:vanshkapoor418@gmail.com" target="_blank">
              vanshkapoor418@gmail.com
            </a>
          </li>
          <li className="flex items-center">
            <GitHub className="w-5 h-5 mr-2" />
            <a href="https://github.com/Liegen47" target="_blank">
              /Fashionista
            </a>
